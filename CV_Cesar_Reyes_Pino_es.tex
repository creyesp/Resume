...
\begin{document}
	...
	\begin{textblock}{58.5}(6,7.7)
		...
		Inicie mi carrera de cientifico de datos en un centro de Neurociencia para luego seguir en el mundo empresarial, siempre con el objetivo de generar valor a partir de los datos. Autodidacta, difusor del conocimiento, docente y Co-orgaizador de la Meetup de Data Science Montevideo.
	...
	{Alphalabs | Montevideo, Uruguay | Junio 2020 - Actualidad}
	{
		...
		\begin{itemize}
			...
			\item Deploy de un modelo basado en Bert usando torchserve.
		\end{itemize}
