...
\begin{document}
	...
	\section{Experiencia Laboral}
		...
		{
			En PedidosYa formó parte del equipo de Analytic Factory donde desarrollamos modelos de ML y herramoentas de analisis a los diferentes equipos de producto. Algunas responsabilidades:
			...
			\begin{itemize}
				...
				\item Usar tecnicas de NLP (transformers) para detection de topicos basados en la semantica.
				\item Desarrollar un framework para automatizar el calculo y reporting de los A/B test de producto.
		...
		{Alphalabs | Montevideo, Uruguay | Junio 2020 - Actualidad}
		{
			...
			\begin{itemize}
				\item Implementar de modelos de ML y ETL en streaming de datos.
				\item Recolectar datos disponible en internet con tecnicas de scraping.
				\item Desarrollar APIs para disponibilizar modelos.
				\item Entrenar Deploy de un modelo basado en Bert usando torchserve.
			\end{itemize}
